                        ...
                        <ul class="dropdown-menu dropdown-info">
                          <c:forEach items="${advList }" var="adv" varStatus="one">
                            <li>
                              ...
                              <a data-toggle="tab" href="#dropdown1">${adv.toSelect }</a>
                            </li>
                        ...
                        <ul class="dropdown-menu dropdown-info">
                          <c:forEach items="${industryList }" var="industry" varStatus="one">
                            <li>
                              ...
                              <a data-toggle="tab" href="#dropdown1">${industry.toSelect }</a>
                            </li>
                        ...
                        <ul class="dropdown-menu dropdown-info">
                          <c:forEach items="${sizeList }" var="size" varStatus="one">
                            <li>
                              ...
                              <a data-toggle="tab" href="#dropdown1">${size.toSelect }</a>
                            </li>
                        ...
                        <ul class="dropdown-menu dropdown-info">
                          <c:forEach items="${classifyList }" var="classify" varStatus="one">
                            <li>
                              ...
                              <a data-toggle="tab" href="#dropdown1">${classify.toSelect }</a>
                            </li>
