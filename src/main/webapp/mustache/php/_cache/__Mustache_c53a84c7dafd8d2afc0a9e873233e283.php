...
class __Mustache_c53a84c7dafd8d2afc0a9e873233e283 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= "\n";
        // 'content' section
        $buffer .= $this->section7e2bce184b91817ad479076cb9257606($context, $indent, $context->find('content'));
        $buffer .= $indent . '	</div>';
        $buffer .= "\n";
        ...
        $buffer .= $this->sectionBb879d4746ab9b919bd1473898de718a($context, $indent, $context->find('badge-important'));
        $buffer .= $indent . '</div>';
    ...
    private function section7e2bce184b91817ad479076cb9257606(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '{{! sometimes we have two content texts like in smaller infoboxes, so loop }}
    ...
    private function sectionBb879d4746ab9b919bd1473898de718a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	 <div class="badge badge-important">{{badge-important}} <i class="icon-arrow-down"></i></div>
	';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source, $this->lambdaHelper))
                ->renderInternal($context, $indent);
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '	 <div class="badge badge-important">';
