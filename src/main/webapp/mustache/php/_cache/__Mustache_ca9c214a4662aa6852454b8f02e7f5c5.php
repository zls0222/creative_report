...
class __Mustache_ca9c214a4662aa6852454b8f02e7f5c5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<form>';
        $buffer .= "\n";
        $buffer .= $indent . '	<div class="form-actions input-append">';
        $buffer .= "\n";
        $buffer .= $indent . '		<input placeholder="Type your message here ..." type="text" class="width-75" name="message" />';
        $buffer .= "\n";
        $buffer .= $indent . '		<button class="btn btn-small btn-info no-radius" onclick="return false;"><i class="icon-share-alt"></i> <span class="hidden-phone">Send</span></button>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
        $buffer .= "\n";
        $buffer .= $indent . '</form>';
